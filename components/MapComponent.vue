    ...
    <div id="my-map">
      <div class="popup-map" :style="{ 'visibility': activePopup.visibility }">
        <div class="flex items-center justify-between border-b my-2">
          <h1 class="font-bold uppercase py-1 px-4">{{ activePopup.location }}</h1>
          <svg @click="closePopup" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="cursor-pointer mx-4" viewBox="0 0 16 16">
